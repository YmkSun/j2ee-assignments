...
<tr><td align="right"><b><s:text name="label.email"/>:</b>&nbsp;</td><td><s:property value="musto.email"/></td></tr>
</table>
...
<tr>
	...
	<td><s:property value="mdetail.musictype" /></td>
