...
<body>
<center>
<h3><s:text name="label.detitle" /></h3>


<s:form action="deletestu" method="post" theme="simple" >
...
<tr><td></td><td><s:submit key="label.delete" /><s:reset key="label.reset" /></td><td></td></tr>
</table>
</s:form>
</center>
</body>
